...
const ReservationCard = ({ property }) => {
  ...
  return (
    <div
      ref={cardRef}
      className="border rounded-xl p-6 shadow-lg h-fit sticky top-24 space-y-4 z-40"
    >
      ...
      <div className="border rounded-lg relative">
        <div className="grid grid-cols-2">
          ...
          >
            <label className="block text-xs uppercase font-semibold text-gray-600">
              Check-in
            </label>
            ...
            <>
              ...
              <div className="absolute z-50 left-0 right-0 mt-2 bg-white rounded-lg shadow-lg border p-4">
                ...
                <GuestTypeSelector
                  ...
                  onChange={(value) =>
                    setGuests({ ...guests, children: value })
                  }
                  max={property.maxGuests}
                />
                <GuestTypeSelector
                ...
                <div className="text-sm text-gray-500 mt-4">
                  {property.maxGuests} guests maximum. Infants don't count
                  toward the guest total.
                </div>
              </div>
            </>
          )}
      ...
      {numberOfNights > 0 && (
        <div className="space-y-4 mt-4 border-t pt-4">
          <div className="flex justify-between text-gray-600">
            <span>
              €{property.price} × {numberOfNights} nights
            </span>
